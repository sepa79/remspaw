...
// HACK to use AngularJS - Material instead of Bootstrap 3
var html = `
<div class=\"ng-cloak ng-table-pager\" ng-if=\"params.data.length\" layout="row" layout-align="space-between start">
    <div ng-if=\"params.settings().counts.length\" class=\"ng-table-counts\">
        <button ng-repeat=\"count in params.settings().counts\" type=\"button\"
                ng-class=\"{'md-primary':params.count() == count}\"
                ng-click=\"params.count(count)\" class=\"md-button paginationGroup\">
            <span ng-bind=\"count\"></span>
        </button>
    </div>
    <ul ng-if=\"pages.length\" class=\"pagination ng-table-pagination\">
